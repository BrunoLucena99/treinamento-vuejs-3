<template>
  ...
  <div class="flex justify-center w-full h-full">
    <div class="flex flex-col w-4/5 max-w-6xl py-10">
      ...
      >
        <span v-if="state.hasErrors"> Erro ao carregar a chave de api </span>
        <span v-else id="apikey">{{store.User.currentUser.apiKey}}</span>
        <div class="flex ml-20 mr-1" v-if="!state.hasErrors">
          <Icon
            @click="handleCopy"
            name='copy'
      ...
      >
        ...
        <pre v-else>&lt;script src="https://BrunoLucena99-feedbacker-widget.netlify.app?api_key={{store.User.currentUser.apiKey}}"&gt;&lt;/script&gt;</pre>
      </div>
